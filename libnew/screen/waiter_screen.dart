...
String taxCum = "";String customerName="";
    ...
    if(selectedBusiness=='Restaurant' && orgWaiterIs=='false'){
     ...
     // await getLastInv('customer_details');
      ...
      updateInv('sales',invNo+1);
       // create(selectedCustomer.toString().trim(), 'customer_report', yourItemsList1);
       //  DocumentSnapshot documentSnapshot=await firebaseFirestore.collection('customer_report').doc(selectedCustomer.toString().trim()).getSavy();
       //  List tempData=documentSnapshot.get('data');
      print('re:$reportnow');

      print('${yourItemsList1[0]}');
      ...
      if(selectedPayment.toString().trim()=='Credit'){
        ...
        for(int k=0;k<cartListText.length;k++){
          ...
          print(stocknow);
          // for(int i =0;i<stocknow.length;i++) {
          //   if (stocknow[i].contains(itemName)) {
          //     print('hah');
          //
          //
          //
              ...
              children: [
                Container(
                  ...
                  child:Row(
                                                    ...
                                                    Container(
                                                      ...
                                                      child: DropdownButtonHideUnderline(
                                                        child: DropdownButton(
                                                          ...
                                                          onChanged: (newValue) {
                                                            setState(() {
                                                            selectedcurrentroute2 = newValue.toString().trim();
                                                            });
                                                          },
                                                        ),
                                                      ),
                                                    ...
                                                    RawMaterialButton(
                                                      onPressed: () async {
                                                        ...
                                                        if(inside == 'not'){
                                                          ...
                                                          await create(body, 'customer_report2',[]);
                    ...
                    //                                           double ac = double.parse(orderData['cartList'][i]['price'])/ double.parse(orderData['cartList'][i]['qty']);
                    //                                           cartdup.add(TextEditingController(text: ac.toString()));
                    //
                    ...
                    //                                               ),),
                    //
                    //                                               Text(snapshot.data.docs[index2].get('customer'),
                    //                                                 maxLines: 2,
                    //                                                 style: TextStyle(
                    //                                                 //fontSize: MediaQuery.of(context).textScaleFactor*15,
                    //                                                 fontWeight: FontWeight.bold,
                    ...
                    // if(selectedBusiness!='Restaurant')
                      ...
                      //           });
                      //     },
                      //     child: Text('Till lose',style: TextStyle(
                      //       color: kFont1Color,
                      //       //fontWeight: FontWeight.bold,
                      //       //  letterSpacing: 1.0,
                                        ...
                                        ElevatedButton(
                                            ...
                                            onPressed: ()async{
                                              setState(() {
                                                ...
                                                salesUomList=[];
                                                salesTotalList=[];
                                                selectedCustomer=appbarCustomerController.text='';
                                                                                ...
                                                                                onPressed: ()async{
                                                                                  ...
                                                                                  if(checkoutFlag==true){
                                                                                    if(!((double.parse(dualPayment3.value.text)+double.parse(dualPayment2.value.text))==double.parse(salesTotal.toStringAsFixed(decimals)))){
                                                                                      ...
                                                                                      Navigator.pop(context);
                                                                                      await checkOut(currentOrder,false,2,'${dualPaymentSelected1.value}*${dualPaymentSelected2.value}', '${double.parse(dualPayment3.value.text).toStringAsFixed(decimals)}*${double.parse(dualPayment2.value.text).toStringAsFixed(decimals)}',false);
                                                                                      setState(() {
                                                                                        currentOrder='';
                                                                                        cartController=[];
                                                                                        cartdup = [];
                                                                                      ...
                                                                                      print('kot e');
                                                                                      Navigator.pop(context);
                                                                                      await checkOut(currentOrder,false,1,'${dualPaymentSelected1.value}', '${double.parse(dualPayment3.value.text).toStringAsFixed(decimals)}',false);
                                                                                      setState(() {
                                                                                        currentOrder='';
                                                                                        cartController=[];
                                                                                        cartQtyController=[];
                                                                                ...
                                                                                onPressed: ()async{
                                                                                  ...
                                                                                  if(checkoutFlag==true){
                                                                                    if(!((double.parse(dualPayment3.value.text)+double.parse(dualPayment2.value.text))==double.parse(salesTotal.toStringAsFixed(decimals)))){
                                                                                      ...
                                                                                      Navigator.pop(context);
                                                                                      await checkOut(currentOrder,true,2,'${dualPaymentSelected1.value}*${dualPaymentSelected2.value}', '${double.parse(dualPayment3.value.text)}*${double.parse(dualPayment2.value.text)}',true);
                                                                                      setState(() {
                                                                                        currentOrder='';
                                                                                        cartController=[];
                                                                                        cartdup = [];
                                                                                      ...
                                                                                      print('r');
                                                                                      Navigator.pop(context);
                                                                                      await checkOut(currentOrder,true,1,'${dualPaymentSelected1.value}', '${double.parse(dualPayment3.value.text)}',true);
                                                                                      setState(() {
                                                                                        currentOrder='';
                                                                                        cartController=[];
                                                                                        cartdup=[];
