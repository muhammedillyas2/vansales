            ...
            SizedBox(
             ...
             // height: 30,
              ...
              child:  SimpleAutoCompleteTextField(
                ...
                clearOnSubmit: false,
                textSubmitted: (text) {
                  if(customerVendor.contains(text.toString().trim())) {
                    if(vendorList.contains(text)){
                      setState(() {
                        netBalanceController.text= getVendorBalance(text.toString().trim());
                      ...
                      setState(() {
                        netBalanceController.text=getCustomerBalance(text.toString().trim());
              ...
              onPressed: ()async {
                if(amountController.text==''){
                  ...
                  if(selectedType=='Receipt') {
                    ...
                    print('y1:$yourItemsList1');
                    print(selected);
                    // await create(selected, 'customer_report', yourItemsList1);
                    // DocumentSnapshot documentSnapshot=await firebaseFirestore.collection('customer_report').doc(selected.toString().trim()).getSavy();
                    // List tempData=documentSnapshot.get('data');
                    int b = reportnow.indexOf(selected.toString().trim());
