              ...
              child: StreamBuilder(
                  ...
                  builder: (BuildContext context,AsyncSnapshot<QuerySnapshot> snapshot){
                    ...
                    [DataColumn(label: Padding(
                      ...
                      child: Text('PartyName', style:TextStyle(
                        ...
                        rows: snapshot.data.docs.map((document) {
                          return DataRow(cells: [
                            DataCell(TextButton(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                       ...
                                                       Column(
                                                        ...
                                                        DataTable(columns: [
                                                          DataColumn(label: Text('Inv.No', style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor * 13,))),
                                                           DataColumn(label: Text('Date', style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor * 13,))),
                                                          DataColumn(label: Text('Total', style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor * 13,))),
                                                          // DataColumn(label: Text('Total', style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor * 16,))),
                                                          // DataColumn(label: Text('Type', style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor * 16,))),
                                                        ],
                                                            rows: List.generate(
                                                                crInv.length, (index) =>
                                                                DataRow(cells: [
                                                                   DataCell(Text(crInv[index], style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor * 14,))),
                                                                    DataCell(Text(convertEpox(crDate[index]).substring(0,10

                                                                    ), style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor * 11,))),
                                                                  // DataCell(Text(crPayment[index].contains('*')?crPayment[index].replaceAll('*','/'):crPayment[index], style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor * 15,))),
                                                                   DataCell(Text(crTotal[index].contains('*')?crTotal[index].replaceAll('*','/'):crTotal[index], style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor * 14,))),
                                                                  // DataCell(Text(crTransaction[index], style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor * 15,)))
                                                        ...
                                                        Container(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                Text('Net Balance',
                                                                  style: TextStyle(
                                                                    fontSize:  currentWidth>600?30.0:15,
                                                                    letterSpacing: 2.0,
                                                                    fontWeight: FontWeight.bold,
                                                                  ),
                                                                ),
                                                                ...
                                                                StreamBuilder(stream: firebaseFirestore.collection(collectionName).doc(docName).snapshots(),
                                                                    builder: (BuildContext context,AsyncSnapshot<DocumentSnapshot> snapshot){
                                                                      ...
                                                                      return Text(balance.toStringAsFixed(decimals),
                                                                        style: TextStyle(
                                                                          fontSize: currentWidth>600?30.0:15.0,
                                                                          fontWeight: FontWeight.bold,
                                                                        ),
                                                                      );
                                                                    }),
                                ...
                                child: Text(document['${type=='RECEIVABLE'?'customerName':'vendorName'}'],style: TextStyle(
                                    fontSize: MediaQuery.of(context).size.width*0.04
                                )))),
                            DataCell(Text(document['balance'],style: TextStyle(
                                fontSize: MediaQuery.of(context).size.width*0.04
                            ))),
                          ]);
                        }).toList());
