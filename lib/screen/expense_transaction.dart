...
class _ExpenseTransactionState extends State<ExpenseTransaction> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      ...
      body: Container(
         padding:EdgeInsets.only(left: MediaQuery.of(context).size.width*0.07,right:MediaQuery.of(context).size.width*0.07,top:MediaQuery.of(context).size.height*0.04 ),
